...
\else
    ...
    \renewcommand{\myfootertext}{Versione Light Mode. Disponibile anche la \href{https://github.com/mirconegri/University/tree/main/2nd_semester/calcolatori/schemi/secondo_parziale/schemi_calcolatori_secondo_parziale_darkV.pdf}{versione Dark Mode}.}    \pagecolor{white}
    \color{black}
\fi
