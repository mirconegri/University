...
\hypersetup{
    ...
    urlcolor=cyan,
    pdftitle={Appunti di Calcolatori},
...
% --- INTESTAZIONE: DEFINIZIONE CONTATORE E COMANDO ---
\newcounter{numdomanda}
\setcounter{numdomanda}{0} % Inizializza a 0

% Questo comando sostituisce \subsection*{Domanda X: ...}
\newcommand{\domanda}[1]{
    \stepcounter{numdomanda}
    \subsection*{Domanda \arabic{numdomanda}: #1}
}
% -----------------------------------------------------

% --- PAGINA 1 ---
\domanda{Decimale in Binario}
...
\begin{itemize}
    ...
    \item[$\blacksquare$] Nessuna delle altre risposte
    \item[$\square$] $01100001000010010100_2$
    \item[$\square$] $01101001000010000100_2$
\end{itemize}
\textbf{Risposta}: Nessuna delle altre risposte (il risultato corretto è $010111100110011011101111_2$) $\rightarrow$ Opzione \#3.
...
% --- PAGINA 8 ---
\domanda{Moltiplicazione Binaria}
...
% --- PAGINA 11 ---
\domanda{Operazione in Complemento a 2 (12 bit)}
...
% --- PAGINA 12 ---
\domanda{Operazione in Complemento a 2 (8 bit)}
...
\newpage
% --- PAGINA 13 ---
\domanda{Virgola Fissa a Decimale}
...
% --- PAGINA 14 ---
\domanda{Decimale a Virgola Fissa}
...
% --- PAGINA 15 ---
\domanda{Somma in Virgola Fissa}
...
% --- PAGINA 17 ---
\domanda{Da IEEE754 Esadecimale a Decimale}
...
% --- PAGINA 18 ---
\domanda{Rappresentazioni Equivalenti}
...
% --- PAGINA 19 ---
\domanda{Da IEEE754 Binario a Decimale}
