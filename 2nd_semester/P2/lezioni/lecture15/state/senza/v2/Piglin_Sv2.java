...
public class Piglin_Sv2 {
    ...
    public void see_player_no_gold(){
        switch (this.state){
            ...
            case AGGRESSIVE_1 -> {}
            case AGGRESSIVE_2 -> {} // rimane
            case AGGRESSIVE_3 -> {} // rimane
            default -> {
    ...
    public void see_player_wearing_gold(){
        switch (this.state){
            ...
            case AGGRESSIVE_2 -> {  // copiato da AGGRESSIVE_1
                this.state = PiglinState_Sv2.FRIENDLY;
                System.out.println("Piglin vede che indossi oro, diventa amichevole");
            }
            case AGGRESSIVE_3 -> {} // non succede nulla, rimane AGGRO_3
            default -> {
                System.out.println("Non hai codificato questa opzione ?");
            }
        }
    }
    public void unsee_player(){ // questo e` sempre lo stesso
    ...
    public void player_opens_chest(){
        switch (this.state){
            ...
            case AGGRESSIVE_1 -> {} // rimane in AGGRO_1
            case AGGRESSIVE_2 -> {} // rimane in AGGRO_2
            case AGGRESSIVE_3 -> {} // rimane in AGGRO_3
            default -> {
                System.out.println("Non hai codificato questa opzione ?");
            }
        }
